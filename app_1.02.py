...
if rol == "Professor" and acces_professor:
    ...
    with tab_compres:
        ...
        nom_correccio = st.text_input(
            "Etiqueta identificativa de la correcció (ADG32_02.01, ADG32_02.02, ADG32_02.03, ...): "
        )
        ...
        if st.button("⚙️ PROCESSAR I DESAR CORRECCIÓ", type="primary"):
            ...
            if (
                ...
                if nom_correccio == "":
                    ...
                    st.success(
                        "✅ LA CÀRREGA DELS ARXIUS I LA SEVA CONVERSIÓ A DATAFRAMES HA ESTAT EXITOSA"
                    )

                    if st.button(
                        "⚙️ INSERTAR DATA ENTREGA TREBALL EN DF DADES REALS",
                        type="primary",
                    ):
                ...
                st.error(
                    "Cal que adjuntis tots els arxius per poder processar la correcció"
                )
