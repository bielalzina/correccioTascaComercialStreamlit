...
# El grup i la tasca vendra informat per una variable:
#
#  prefNomFitxerCorreccio = grup + "_" + tasca + "_"

prefNomFitxerCorreccio = "ADG32O_02.12_"
...
fileNameReal = prefNomFitxerCorreccio + "00_DATOS_COMPRAS_REALES.csv"
fileNamePed = prefNomFitxerCorreccio + "01_DATOS_PEDIDOS_COMPRA_ALUMNOS.csv"
fileNameAlb = prefNomFitxerCorreccio + "02_DATOS_ALBARANES_COMPRA_ALUMNOS.csv"
fileNameFac = prefNomFitxerCorreccio + "03_DATOS_FACTURAS_COMPRA_ALUMNOS.csv"
fileNameFechaEntrega = prefNomFitxerCorreccio + "04_FECHA_ENTREGA_TRABAJOS.csv"

carpeta = "LLISTATS_CSV"

try:
    df_real = logic_comu.carregaCSV(fileNameReal, carpeta)
    df_ped = logic_comu.carregaCSV(fileNamePed, carpeta)
    df_alb = logic_comu.carregaCSV(fileNameAlb, carpeta)
    df_fac = logic_comu.carregaCSV(fileNameFac, carpeta)
    df_fechaEntrega = logic_comu.carregaCSV(fileNameFechaEntrega, carpeta)
...
df_alumnes_morosos = df_fechaEntrega[df_fechaEntrega["Estat entrega"] == "NO ENTREGADA"]
