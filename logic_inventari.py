...
# NUMERIQUES
df_resum_stock["A_COST_UNITARI_I"] = pd.to_numeric(
    df_resum_stock["A_COST_UNITARI_I"], errors="coerce"
).fillna(0.00)
df_resum_stock["A_IMPORT_I"] = pd.to_numeric(
    df_resum_stock["A_IMPORT_I"], errors="coerce"
).fillna(0.00)
df_resum_stock["A_UNITATS_REALS_I"] = pd.to_numeric(
    df_resum_stock["A_UNITATS_REALS_I"], errors="coerce"
).fillna(0.00)
df_resum_stock["A_UNITATS_DISPONIBLES_I"] = pd.to_numeric(
    df_resum_stock["A_UNITATS_DISPONIBLES_I"], errors="coerce"
).fillna(0.00)
df_resum_stock["A_UNITATS_PENDENTS_ENTRAR_I"] = pd.to_numeric(
    df_resum_stock["A_UNITATS_PENDENTS_ENTRAR_I"], errors="coerce"
).fillna(0.00)
df_resum_stock["A_UNITATS_PENDENTS_SORTIR_I"] = pd.to_numeric(
    df_resum_stock["A_UNITATS_PENDENTS_SORTIR_I"], errors="coerce"
).fillna(0.00)
...
df_resum_stock["CLAU_UNICA"] = (
    df_resum_stock["A_EXPEDIENT_I"] + df_resum_stock["A_PRODUCTE_I"]
)
df_hes_inventari["CLAU_UNICA"] = (
    df_hes_inventari["A_EXPEDIENT_HES"] + df_hes_inventari["A_PRODUCTE_HES"]
)
